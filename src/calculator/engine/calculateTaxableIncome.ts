...
const UNSUPPORTED_CATEGORIES: Array<[keyof TaxCalculationInput, string]> = [
  ["business", "Business / Profession income"],
 ...
 * Refuses to calculate if the input includes any category whose tax
 * treatment hasn't been supplied yet, rather than silently including
 * it at face value.
 */
export function calculateTaxableIncome(
  ...
  return {
    ...
    breakdown: { salary, houseProperty, financialAssets },
  };
}